 ...
 * the License.
 */
package org.apache.struts2.webjars.interceptor;
...
public class WebjarsRequestInterceptor extends AbstractInterceptor {

	protected static final Logger LOG = LogManager.getLogger(WebjarsRequestInterceptor.class);
